...
public class ExcelUtils {
    ...
    public static XSSFWorkbook createExcelFile(Class<?> clazz, List<HashMap<String, Object>> objs,
            Map<Integer, List<ExcelBean>> map, String sheetName) throws Exception {
        // 创建新的Excel 工作簿
